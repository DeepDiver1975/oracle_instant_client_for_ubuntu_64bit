...
class SystemSetup(object):
	...
	def oracle_setup(self):
		...
		subprocess.check_call(
			['alien',
			'-iv',
			'oracle_rpms/oracle-instantclient12.1-basic-12.1.0.2.0-1.x86_64.rpm'])

		subprocess.check_call(
			['alien',
			'-iv',
			'oracle_rpms/oracle-instantclient12.1-sqlplus-12.1.0.2.0-1.x86_64.rpm'])

		subprocess.check_call(
			['alien',
			'-iv',
			'oracle_rpms/oracle-instantclient12.1-devel-12.1.0.2.0-1.x86_64.rpm'])
		...
		oracle_configuration_file.write('/usr/lib/oracle/12.1/client64/lib\n')
		...
		os.makedirs('/usr/lib/oracle/12.1/client64/network/admin')
